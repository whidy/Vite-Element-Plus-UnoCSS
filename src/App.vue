    ...
    <div h-full flex flex-col>
      ...
      <p>
        ...
        >和<a
          ...
          target="_blank"
          >element-plus-best-practices</a
        >
      </p>
      <el-space direction="vertical">
        <div i-mdi-alarm text-blue-800 text-2xl />
        <div class="i-ep-aim text-orange-400" />
      </el-space>
      <el-button-group flex justify-center>
        <el-button type="primary" @click="handleClick"> alert </el-button>
